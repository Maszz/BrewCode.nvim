...
function M.get()
    return {
        ...
        Cursor = { fg = "#abcddf", bg = "#f2d5cf" },   -- character under the cursor
        lCursor = { fg = "#abcddf", bg = "#f2d5cf" },  -- the character under the cursor when |language-mapping| is used (see 'guicursor')
        CursorIM = { fg = "#abcddf", bg = "#f2d5cf" }, -- like Cursor, but used when in IME mode |CursorIM|
